...
# copied (yes, dirty) from:
#   https://github.com/tiiuae/px4-firmware/blob/master/Tools/mavlink_shell.py
...
def main():
    ...
    parser.add_argument('port', metavar='PORT', nargs='?', default = 'tcp:192.168.100.2:5760',
